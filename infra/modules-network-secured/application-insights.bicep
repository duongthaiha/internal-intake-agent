...
@description('Connection string for the Application Insights component (repo-local addition so azd/scripts can export APPLICATIONINSIGHTS_CONNECTION_STRING without a second lookup).')
