...
from history import ObservableCosmosHistoryProvider
from logging_config import LOG_LEVEL_NAMES, configure_logging
from rag import build_rag_provider
...
def build_agent() -> AgentComponents:
    ...
    agent = create_harness_agent(
        ...
        agent_instructions=(
            "You are a concise, helpful AI assistant. When retrieved knowledge "
            "is available, answer factual questions from that knowledge instead "
            "of substituting general assumptions, cite its source, and say when "
            "the available context does not contain the answer."
        ),
